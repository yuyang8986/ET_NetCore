...
{
    public class P8BusinessIncomeAndExpensesNonFarming
    {
        //Income
        public int P8BusinessIncomeAndExpensesNonFarmingId { get; set; }
        public int GrossABNNotQuoted { get; set; }
        public int GrossSubjectToForeignResidentWithHoldingExcludingCapitalGains { get; set; }
